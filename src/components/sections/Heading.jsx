...
const Heading = () => {
  return (
    <div className='flex flex-col w-full items-center justify-center py-20 gap-5'>
            ...
            <p className='mb-3 sm:text-center text-justify max-w-[600px] h-auto'>James here, I'm still working on developing the website, iNTFibeR. I've used random materials and the same labels on every division. However, I'll start working on that as well as the server and database once I've finished developing the entire front-end of the website. Thank you!</p>
